...
cmd:option('-popArt', 'true', 'Use Pop-Art normalised update')
-- Evaluation options
...
-- Check Pop-Art is not used with TD-error clipping
if opt.tdClip > 0 and opt.popArt then
  log.error('popArt should not be used with TD-error δ clipping')
  error('popArt should not be used with TD-error δ clipping')
end
